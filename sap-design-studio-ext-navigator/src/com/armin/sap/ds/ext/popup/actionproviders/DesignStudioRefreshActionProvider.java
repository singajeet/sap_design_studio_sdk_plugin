...
public class DesignStudioRefreshActionProvider extends CommonActionProvider {

	private RefreshAction refreshAction;
	private Shell shell;
	
	public DesignStudioRefreshActionProvider() {
	...
	protected void makeActions() {
				...
				WorkspaceJob job = new WorkspaceJob("refresh") {
					...
					public IStatus runInWorkspace(IProgressMonitor monitor) throws CoreException{
						try {
							...
							throw new CoreException(new Status(IStatus.ERROR, Activator.PLUGIN_ID, IStatus.ERROR, msg, e.getTargetException()));
		...
		refreshAction.setDisabledImageDescriptor(getImageDescriptor("images/reload_hover.png"));
		refreshAction.setImageDescriptor(getImageDescriptor("images/reload_regular.png"));
