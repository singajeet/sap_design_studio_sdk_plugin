...
public abstract class AbstractBaseEditorPart extends FormPage {

	private boolean dirty;
	
	public AbstractBaseEditorPart(String id, String title) {
		super(id, title);
		// TODO Auto-generated constructor stub
	}

	public AbstractBaseEditorPart(FormEditor editor, String id, String title) {
