...
public class ComponentClientObjectPattern extends AbstractPattern implements IPattern {
	...
	public String getCreateName() {
	      return "Component - Client Object";
	}
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		...
		return mainBusinessObject instanceof EClass;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		ComponentDiagramEditorInput input = (ComponentDiagramEditorInput)uiContainer.getDiagramEditorInput();
		ComponentNode node = input.getNode();
		
		HashMap<String, String> inputMap = Prompts.askComponentIdAndTitle(node);
        ...
        newClass.setName(inputMap.get(IDEConstants.COMPONENT_ID) + "." + inputMap.get(IDEConstants.COMPONENT_TITLE));
