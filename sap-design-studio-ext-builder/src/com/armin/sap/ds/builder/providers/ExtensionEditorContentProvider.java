...
public class ExtensionEditorContentProvider implements IStructuredContentProvider, IResourceChangeListener {

	private Viewer _viewer;
    private ExtensionCollectionNode _input;
    
    public ExtensionEditorContentProvider() {
    	ResourcesPlugin.getWorkspace().addResourceChangeListener(this, IResourceChangeEvent.POST_CHANGE);
    }
    
    public ExtensionEditorContentProvider(ExtensionCollectionNode input) {
    	_input = input;
    	ResourcesPlugin.getWorkspace().addResourceChangeListener(this, IResourceChangeEvent.POST_CHANGE);
    }
