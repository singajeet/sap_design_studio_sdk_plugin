 ...
 * @generated
 */
public class ExtendedFactory extends EFactoryImpl implements IExtendedFactory {
	/**
	 ...
	 * @generated
	 */
	public static IExtendedFactory init() {
		try {
			IExtendedFactory theExtendedFactory = (IExtendedFactory)EPackage.Registry.INSTANCE.getEFactory(IExtendedPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case IExtendedPackage.CLIENT_COMPONENT: return createClientComponent();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case IExtendedPackage.SDK_BASE_CLASS_TYPE:
	 ...
	 * @generated
	 */
	public IClientComponent createClientComponent() {
	 ...
	 * @generated
	 */
	public IExtendedPackage getExtendedPackage() {
		return (IExtendedPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static IExtendedPackage getPackage() {
		return IExtendedPackage.eINSTANCE;
	}
